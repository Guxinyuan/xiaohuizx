$(document).ready(function(){
	...
	$('#zhiyuanyi').change(function(){
		...
		if (v1 == '校团委') {
			...
			$('#zhiyuanyi2').append("<option value='网络与新媒体运营部'>网络与新媒体运营部</option>");
		}
		else if(v1 == '校学生会'){
			$("#zhiyuanyi2").empty();
			...
			$("#zhiyuanyi2").empty();
			$('#zhiyuanyi2').append("<option value='办公室'>办公室</option>");
			$('#zhiyuanyi2').append("<option value='学实部'>学实部</option>");
			$('#zhiyuanyi2').append("<option value='外联部'>外联部</option>");
...
$('#zhiyuaner').change(function(){
		...
		if (v2 == '校团委') {
			...
			$('#zhiyuaner2').append("<option value='网络与新媒体运营部'>网络与新媒体运营部</option>");
		}
		else if(v2 == '校学生会'){
			$("#zhiyuaner2").empty();
			...
			$("#zhiyuaner2").empty();
			$('#zhiyuaner2').append("<option value='办公室'>办公室</option>");
			$('#zhiyuaner2').append("<option value='学实部'>学实部</option>");
			$('#zhiyuaner2').append("<option value='外联部'>外联部</option>");
...
$('#zhiyuansan').change(function(){
		...
		if (v3 == '校团委') {
			...
			$('#zhiyuansan2').append("<option value='网络与新媒体运营部'>网络与新媒体运营部</option>");
		}
		else if(v3 == '校学生会'){
			$("#zhiyuansan2").empty();
			...
			$("#zhiyuansan2").empty();
			$('#zhiyuansan2').append("<option value='办公室'>办公室</option>");
			$('#zhiyuansan2').append("<option value='学实部'>学实部</option>");
			$('#zhiyuansan2').append("<option value='外联部'>外联部</option>");
